...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: currentTheme.background }]}>
      ...
      <Modal visible={showPushNotificationModal} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView style={[styles.modalContainer, { backgroundColor: currentTheme.background }]}>
          <View style={[styles.modalHeader, { borderBottomColor: currentTheme.border }]}>
            <TouchableOpacity onPress={() => setShowPushNotificationModal(false)}>
              <Text style={[styles.modalCancel, { color: currentTheme.textSecondary }]}>{t('common.cancel')}</Text>
            </TouchableOpacity>
            <Text style={[styles.modalTitle, { color: currentTheme.text }]}>{t('settings.permissionRequired')}</Text>
            <View style={{ width: 60 }} />
          </View>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            <View style={modalStyles.warningSection}>
              ...
              <Text style={[modalStyles.warningTitle, { color: currentTheme.text }]}>{t('settings.notificationPermissionTitle')}</Text>
              ...
              <View style={[modalStyles.listContainer, { backgroundColor: currentTheme.surface }]}>
                <View style={modalStyles.listItem}>
                  <Ionicons name="chatbubbles-outline" size={16} color={currentTheme.textSecondary} />
                  <Text style={[modalStyles.listItemText, { color: currentTheme.textSecondary }]}>{t('settings.newMessageNotifications')}</Text>
                </View>
                <View style={modalStyles.listItem}>
                  <Ionicons name="heart-outline" size={16} color={currentTheme.textSecondary} />
                  <Text style={[modalStyles.listItemText, { color: currentTheme.textSecondary }]}>{t('settings.likeNotifications')}</Text>
                </View>
                <View style={modalStyles.listItem}>
                  <Ionicons name="chatbox-outline" size={16} color={currentTheme.textSecondary} />
                  <Text style={[modalStyles.listItemText, { color: currentTheme.textSecondary }]}>{t('settings.commentNotifications')}</Text>
                </View>
                <View style={[modalStyles.listItem, { borderBottomWidth: 0 }]}>
                  <Ionicons name="people-outline" size={16} color={currentTheme.textSecondary} />
                  <Text style={[modalStyles.listItemText, { color: currentTheme.textSecondary }]}>{t('settings.connectionNotifications')}</Text>
                </View>
              </View>
            ...
            >
              ...
              <Text style={modalStyles.deleteButtonText}>{t('settings.openSettings')}</Text>
            </TouchableOpacity>
          </ScrollView>
        </SafeAreaView>
      </Modal>
