...
interface ProfileEditSuccessModalProps {
  visible: boolean;
  onClose: () => void;
...
export default function ProfileEditSuccessModal({
  visible,
  onClose,
  animation,
  currentTheme,
}: ProfileEditSuccessModalProps) {
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={[styles.successTitle, { color: currentTheme.text }]}>
            {t('settings.profileUpdatedSuccessfully')}
          </Text>
          <Text style={[styles.successMessage, { color: currentTheme.textSecondary }]}>
            {t('settings.profileUpdateMessage')}
          </Text>
        </Animated.View>
      </View>
    </Modal>
